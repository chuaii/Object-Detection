...
class BaseModel(nn.Module):
    ...
    def loss(self, batch, preds=None):
        ...
        preds = self.forward(batch["img_video_source"]) if preds is None else preds
...
class DetectionModel(BaseModel):
    ...
    def __init__(self, cfg="yolov8n_input6.yaml", ch=3, nc=None, verbose=True):  # model, input channels, number of classes
...
class WorldModel(DetectionModel):
    ...
    def loss(self, batch, preds=None):
        ...
        if preds is None:
            preds = self.forward(batch["img_video_source"], txt_feats=batch["txt_feats"])
        return self.criterion(preds, batch)
