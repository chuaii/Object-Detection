...
class Explorer:
    ...
    def create_embeddings_table(self, force: bool = False, split: str = "train") -> None:
        ...
        table.add(
            self._yield_batches(
                ...
                data_info,
                self.model,
                exclude_keys=["img_video_source", "ratio_pad", "resized_shape", "ori_shape", "batch_idx"],
            )
        )
    ...
    def query(
        ...
        Example:
            ...
            exp = Explorer()
            exp.create_embeddings_table()
            similar = exp.query(img_video_source="https://ultralytics.com/images/zidane.jpg")
            ```
        """
        ...
        if isinstance(imgs, str):
            imgs = [imgs]
        assert isinstance(imgs, list), f"img_video_source must be a string or a list of strings. Got {type(imgs)}"
    ...
    def get_similar(
        ...
        Example:
            ...
            exp = Explorer()
            exp.create_embeddings_table()
            similar = exp.get_similar(img_video_source="https://ultralytics.com/images/zidane.jpg")
            ```
        """
    ...
    def plot_similar(
        ...
        Example:
            ...
            exp = Explorer()
            exp.create_embeddings_table()
            similar = exp.plot_similar(img_video_source="https://ultralytics.com/images/zidane.jpg")
            ```
        """
    ...
    def _check_imgs_or_idxs(
        ...
        if img is None and idx is None:
            raise ValueError("Either img_video_source or idx must be provided.")
        if img is not None and idx is not None:
            raise ValueError("Only one of img_video_source or idx must be provided.")
        if idx is not None:
