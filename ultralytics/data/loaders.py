...
class LoadScreenshots:
    ...
    def __next__(self):
        ...
        self.frame += 1
        return [str(self.screen)], [im0], [s]  # screen, img_video_source, string
...
class LoadImagesAndVideos:
    ...
    def __init__(self, path, batch=1, vid_stride=1):
        ...
        parent = None
        if isinstance(path, str) and Path(path).suffix == ".txt":  # *.txt file with img_video_source/vid/dir on each line
