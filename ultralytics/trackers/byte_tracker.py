...
class BYTETracker:
    ...
    Methods:
        update(results, img_video_source=None): Updates object tracker with new detections.
        get_kalmanfilter(): Returns a Kalman filter object for tracking bounding boxes.
        init_track(dets, scores, cls, img_video_source=None): Initialize object tracking with detections.
