...
Usage:
    ...
    ProfileModels(['yolov8n_input6.yaml', 'yolov8s.yaml']).profile()
...
class RF100Benchmark:
        ...
        with open(ds_link_txt) as file:
            for line in file:
                try:
                    ...
                    self.ds_cfg_list.append(Path.cwd() / proj_version / "taozi.yaml")
                except Exception:
                    continue
    ...
    def fix_yaml(path):
        ...
        Examples:
            >>> RF100Benchmark.fix_yaml("path/to/taozi.yaml")
        """
    ...
    def evaluate(self, yaml_path, val_log_file, eval_log_file, list_ind):
        ...
        Examples:
            ...
            >>> benchmark = RF100Benchmark()
            >>> benchmark.evaluate("path/to/taozi.yaml", "path/to/val_log.txt", "path/to/eval_log.txt", 0)
        """
        skip_symbols = ["🚀", "⚠️", "💡", "❌"]
...
class ProfileModels:
    ...
    Examples:
        ...
        >>> profiler = ProfileModels(["yolov8n_input6.yaml", "yolov8s.yaml"], imgsz=640)
        >>> profiler.profile()
    """
