...
class Exporter:
    ...
    def export_openvino(self, prefix=colorstr("OpenVINO:")):
        ...
        if self.args.int8:
            ...
            def transform_fn(data_item) -> np.ndarray:
                ...
                data_item: torch.Tensor = data_item["img_video_source"] if isinstance(data_item, dict) else data_item
        ...
        if int8:
            ...
            class EngineCalibrator(trt.IInt8Calibrator):
                ...
                def get_batch(self, names) -> list:
                    ...
                    try:
                        im0s = next(self.data_iter)["img_video_source"] / 255.0
    ...
    def export_saved_model(self, prefix=colorstr("TensorFlow SavedModel:")):
        ...
        if self.args.int8:
            ...
            if self.args.data:
                f.mkdir()
                images = [batch["img_video_source"].permute(0, 2, 3, 1) for batch in self.get_int8_calibration_dataloader(prefix)]
